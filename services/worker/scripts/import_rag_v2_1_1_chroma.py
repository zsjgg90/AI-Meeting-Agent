...
DEFAULT_INPUT_FILE = (
    ...
    / "rag"
    / "v2_1_1"
    / "meeting_analyst_rag_v2_1_1_88.jsonl"
)

DEFAULT_DB_DIR = PROJECT_ROOT / "data" / "vector_db"

DEFAULT_COLLECTION = "meeting_analyst_rules_v2_1_1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Import MeetMind RAG v2.1.1 rules "
    ...
    parser.add_argument(
        ...
        help="RAG v2.1.1 JSONL source file.",
    )
...
def main() -> int:
    ...
    print("\n============================")
    print("RAG v2.1.1 Import Success")
    print("============================")
...
if __name__ == "__main__":
    try:
        ...
        print(
            f"RAG v2.1.1 import failed: {error}",
            file=sys.stderr,
        )
        raise SystemExit(1)