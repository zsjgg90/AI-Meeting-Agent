...
class AgentConfirmationApiTest(unittest.TestCase):
    ...
    def auth_headers(self, permissions: str = "agent_write:AgentActionItem,agent_review") -> dict[str, str]:
        return {"X-Agent-Reviewer": "reviewer-1", "X-Agent-Permissions": permissions}
    ...
    def create_action_proposal(self, **overrides) -> dict:
        ...
        response = self.client.post(
            ...
            json=payload,
            headers=self.auth_headers("agent_proposal:create"),
        )
